...
enum SummaryPrompt {
    ...
    static func userPrompt(meeting: Meeting) -> String {
        ...
        var speakerLegend = (meeting.selfName == nil || meeting.othersName == nil)
        ...
        let hasDiarizedLabels = meeting.othersName == nil && meeting.transcript.contains {
            $0.speaker == .others && $0.diarizedSpeaker != nil
        }
        if hasDiarizedLabels {
            speakerLegend += " Labels like Speaker A and Speaker B distinguish different remote participants identified by automatic speaker diarization."
        }
    ...
    static var jsonSchema: [String: Any] {
        [
            ...
            "properties": [
                "overview": [
                    "type": "string",
                    "description": "A one-sentence abstract followed by 2-4 sentences on the main discussion threads."
                ] as [String: Any],
                "topics": [
                    "type": "array",
                ...
                "details": [
                    "type": "array",
                    "description": "4-10 thematic/chronological sections; empty when the transcript is too thin.",
                    "items": [
                        "type": "object",
                        "additionalProperties": false,
                ...
                "actionItems": [
                    "type": "array",
                    "description": "Follow-up tasks: \"Owner: verb-led title — one-sentence description (due date only if stated)\".",
                    "items": ["type": "string"]
                ] as [String: Any],
                "openQuestions": [
                    "type": "array",
