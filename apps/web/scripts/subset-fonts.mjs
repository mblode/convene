...
// outside Basic Latin.
// Basic Latin, Latin-1 Supplement, Latin Extended-A, then the punctuation,
// currency, arrow, minus, bullet and check-mark ranges the copy needs. The
// order below matches that listing.
const UNICODES = [
  "U+0020-007E",
  "U+00A0-00FF",
  "U+0100-017F",
...
for (const font of FONTS) {
  const src = path.join(sourceDir, font);
  const dest = path.join(outDir, font);
