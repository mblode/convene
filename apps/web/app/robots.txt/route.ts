// Served at /convene/robots.txt via basePath. Crawlers only read robots.txt
// from a host root, so blode.co/robots.txt governs the proxied path; this file is
// what convene.blode.co resolves to, since that subdomain 308s to
// blode.co/convene and both Google and Search Console follow the redirect.
//
